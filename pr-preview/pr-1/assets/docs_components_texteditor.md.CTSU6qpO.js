import{_ as z}from"./chunks/PropsTable.vue_vue_type_script_setup_true_lang.BQ7yORkK.js";import{_ as x}from"./chunks/SlotsTable.vue_vue_type_script_setup_true_lang.CdHubUDb.js";import{_ as b}from"./chunks/EmitsTable.vue_vue_type_script_setup_true_lang.DwjPw_Jf.js";import{Z as y,ab as u,j as g,aM as m}from"./chunks/theme.D4XU_0P1.js";import{y as f,a1 as _,m as w,aI as p,l as s,u as l,an as c,t as a,a6 as h,aa as v,o as j}from"./chunks/framework.m0AnCrU8.js";const k={class:"mt-2 flex flex-col justify-between sm:flex-row sm:items-center"},C={class:"mt-2 flex items-center justify-end space-x-2 sm:mt-0"},E=f({__name:"Comment",setup(r){const t=h(""),o=["Paragraph",["Heading 2","Heading 3","Heading 4"],"Separator","Bold","Italic","Separator","Bullet List","Numbered List","Separator","Link","Image"];return(i,e)=>(_(),w(c(m),{ref:"textEditor","editor-class":"prose-sm max-w-none min-h-[4rem]",content:t.value,onChange:e[0]||(e[0]=n=>t.value.value=n),"starterkit-options":{heading:{levels:[2,3,4]}},placeholder:"Write something amazing..."},{editor:p(({editor:n})=>[l(c(g),{class:"max-h-[50vh] overflow-y-auto border rounded-lg p-4",editor:n},null,8,["editor"])]),bottom:p(()=>[s("div",k,[l(c(y),{class:"-ml-1 overflow-x-auto",buttons:o}),s("div",C,[l(c(u),null,{default:p(()=>[...e[1]||(e[1]=[a("Cancel",-1)])]),_:1}),l(c(u),{variant:"solid"},{default:p(()=>[...e[2]||(e[2]=[a("Submit",-1)])]),_:1})])])]),_:1},8,["content"]))}}),T=f({__name:"Example",setup(r){const t=h(`
<div>
  <h2>Heading 2</h2>
  <p>
